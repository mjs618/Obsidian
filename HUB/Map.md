...
> [!home]+ Dusk Structure
> [[HUB/Home]] 负责日常行动，本页负责解释全库结构。Dusk 模块是工作流层，编号目录和少量稳定主题目录是内容库层。
...
| 内容库层 | `00-管理`、`10-技术笔记`、`20-AI`、`30-工作`、`40-知识库`、`50-生活`、`60-思维笔记`、`70-数据资料`、`80-Clippings`、`90-Excalidraw`、`99-归档`、`Templates`、`投资`、`未分类` | 长期保存笔记、资料、模板、项目和归档 |
...
| 跟踪黄金市场 | [[投资/00-索引|投资研究]] | 黄金周报和研究材料 |
