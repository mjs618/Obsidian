...
source_path: 'prompts/07-ai-coding/ai-system-architect.md'
source_section: '7.1'
source_author: '姚金刚'
source_version: 'V1.0'
source_created: ''
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/07-ai-coding/ai-system-architect.md`。
> 分类：[[20-AI/AI提示词库/07-编程与架构/00-索引|编程与架构]] / 架构。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。
