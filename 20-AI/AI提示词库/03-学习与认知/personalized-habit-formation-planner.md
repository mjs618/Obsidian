...
source_path: 'prompts/03-ai-learning/personalized-habit-formation-planner.md'
source_section: '3.1'
source_author: 'AI助手'
source_version: 'V 0.9'
source_created: '2025-06-08'
license: 'CC BY 4.0'
imported: '2026-05-08'
status: 'active'
tags:
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/03-ai-learning/personalized-habit-formation-planner.md`。
> 分类：[[20-AI/AI提示词库/03-学习与认知/00-索引|学习与认知]] / 习惯养成。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。
