...
source_path: 'prompts/04-ai-life/personalized-parent-child-song.md'
source_section: '4.2'
source_author: '姚金刚'
source_version: 'V1.0'
source_created: '2024-05-24'
license: 'CC BY 4.0'
imported: '2026-05-08'
status: 'active'
tags:
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/04-ai-life/personalized-parent-child-song.md`。
> 分类：[[20-AI/AI提示词库/04-生活助理/00-索引|生活助理]] / 歌曲。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。
