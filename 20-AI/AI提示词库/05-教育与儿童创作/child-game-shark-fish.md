...
source_path: 'prompts/05-ai-education/children-games/child-game-shark-fish.md'
source_section: '5.1'
source_author: '姚金刚'
source_version: 'V1.0'
source_created: ''
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/05-ai-education/children-games/child-game-shark-fish.md`。
