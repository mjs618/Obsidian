...
source_path: 'prompts/01-ai-methods/interactive-rtf-meta-prompt-system.md'
source_section: '1.3'
source_author: '姚金刚'
source_version: 'V1.0'
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/01-ai-methods/interactive-rtf-meta-prompt-system.md`。
