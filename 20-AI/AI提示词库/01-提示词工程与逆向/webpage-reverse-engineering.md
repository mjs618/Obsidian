...
source_path: 'prompts/01-ai-methods/webpage-reverse-engineering.md'
source_section: '05-Prompts/Meta/Prompt-Engineering'
source_author: '姚金刚'
source_version: 'V1.0'
source_created: '2024-06-24'
license: 'CC BY 4.0'
imported: '2026-05-08'
status: 'active'
tags:
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/01-ai-methods/webpage-reverse-engineering.md`。
> 分类：[[20-AI/AI提示词库/01-提示词工程与逆向/00-索引|提示词工程与逆向]] / 反向工程。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。

> [!warning] 使用边界
> 只学习信息架构、布局层级、交互模式和工程思路，不复制品牌识别、商标、专有视觉资产、原站文案、源代码或可识别页面细节。生成页面时必须替换为新的品牌、场景、内容和视觉系统。
