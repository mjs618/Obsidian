...
source_path: 'prompts/01-ai-methods/meta-prompt-rtf-generator.md'
source_section: '1.1'
source_author: '姚金刚'
source_version: 'V1.0'
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/01-ai-methods/meta-prompt-rtf-generator.md`。
> 分类：[[20-AI/AI提示词库/01-提示词工程与逆向/00-索引|提示词工程与逆向]] / 元提示词。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。
