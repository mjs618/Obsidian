...
source_path: 'prompts/02-ai-work/private-domain-sales-prompt.md'
source_section: '2.4'
source_author: '姚金刚'
source_version: 'V1.3'
source_created: ''
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/02-ai-work/private-domain-sales-prompt.md`。
> 分类：[[20-AI/AI提示词库/02-工作生产力/00-索引|工作生产力与交付]] / 销售。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。
