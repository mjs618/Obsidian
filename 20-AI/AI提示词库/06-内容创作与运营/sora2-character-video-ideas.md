...
source_path: 'prompts/06-ai-content/sora2-character-video-ideas.md'
source_section: '6.5'
source_author: '姚金刚'
source_version: 'V1.0'
source_created: ''
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/06-ai-content/sora2-character-video-ideas.md`。
