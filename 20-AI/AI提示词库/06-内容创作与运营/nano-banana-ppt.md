...
source_path: 'prompts/06-ai-content/nano-banana-ppt.md'
source_section: '6.7'
source_author: '姚金刚'
source_version: 'V1.0'
source_created: ''
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/06-ai-content/nano-banana-ppt.md`。
> 分类：[[20-AI/AI提示词库/06-内容创作与运营/00-索引|内容创作与运营]] / Nano Banana PPT。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。
