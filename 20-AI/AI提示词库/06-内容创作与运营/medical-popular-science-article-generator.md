...
source_path: 'prompts/06-ai-content/medical-popular-science-article-generator.md'
source_section: '1.6'
source_author: '姚金刚'
source_version: 'V1.0'
source_created: ''
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/06-ai-content/medical-popular-science-article-generator.md`。
> 分类：[[20-AI/AI提示词库/06-内容创作与运营/00-索引|内容创作与运营]] / 写作。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。

> [!warning] 使用边界
> 这是医疗健康科普写作模板，不是诊疗建议。内容必须基于可信医学资料，并避免虚构医生身份、临床病例、验方效果或治疗承诺。发布前应由具备资质的医疗专业人员审核。
