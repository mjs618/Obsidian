...
source_path: 'prompts/06-ai-content/humanized-writing/humanized-writing-polish-v3.md'
source_section: '05-Prompts/Generators/Content'
source_author: '姚金刚'
source_version: 'V3.0'
source_created: '2025-09-25'
license: 'CC BY 4.0'
imported: '2026-05-08'
status: 'active'
tags:
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/06-ai-content/humanized-writing/humanized-writing-polish-v3.md`。
> 分类：[[20-AI/AI提示词库/06-内容创作与运营/00-索引|内容创作与运营]] / 文章润色。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。
