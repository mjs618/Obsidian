...
source_path: 'prompts/06-ai-content/humanized-writing/humanized-writing-v2.md'
source_section: '6.1'
source_author: '姚金刚'
source_version: 'V2.0 - 深度反AI检测优化版'
source_created: '2025-09-21'
license: 'CC BY 4.0'
imported: '2026-05-08'
status: 'active'
tags:
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/06-ai-content/humanized-writing/humanized-writing-v2.md`。
