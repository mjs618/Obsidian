...
source_path: 'prompts/06-ai-content/cut-everything-video-generator.md'
source_section: '1.7'
source_author: '姚金刚'
source_version: 'V1.0'
...
> [!info] 来源与使用
> 来源：Yao Open Prompts；许可：CC BY 4.0；原路径：`prompts/06-ai-content/cut-everything-video-generator.md`。
> 分类：[[20-AI/AI提示词库/06-内容创作与运营/00-索引|内容创作与运营]] / 视频创意。使用时复制下方 Prompt 区域，并把变量或占位符替换为真实任务。
